...
const TraditionalCuisineBenefits = ({ heading }: { heading: string }) => {
  return (
    <section className="mx-auto mt-10 flex flex-col items-center justify-center px-5 lg:mt-10 lg:w-4/5 lg:py-20">
      <h1 className="heading w-full py-10 text-center font-semibold leading-tight lg:w-1/2">{heading}</h1>
