  ...
  return (
    <section className="relative flex w-full">
      <div className="w-full flex-col items-center justify-center rounded-[30px] bg-[#FFEDDF] py-8 lg:py-20">
        <div className="flex flex-col items-center justify-center gap-5 text-center dark:text-white">
        ...
        <figure>
          ...
          <figcaption className="subheading flex flex-col gap-3 text-center dark:text-white">
            <h2 className="text-[0.9rem] lg:text-[24px]">{name}</h2>
            <p className="subheading text-gray-500">{role}</p>
          </figcaption>
        </figure>
      </div>
    </section>
